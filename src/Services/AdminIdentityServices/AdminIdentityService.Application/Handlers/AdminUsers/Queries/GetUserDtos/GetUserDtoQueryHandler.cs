...
public record GetUserDtoQuery(string? Email) : IRequest<DataResult<GetUserDto>>;

public class GetUserDtoQueryHandler(ICoreDbContext context) : IRequestHandler<GetUserDtoQuery, DataResult<GetUserDto>>
{
