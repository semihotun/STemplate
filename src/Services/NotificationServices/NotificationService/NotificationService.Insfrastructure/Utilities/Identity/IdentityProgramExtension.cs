...
using NotificationService.Insfrastructure.Utilities.Security.Encyption;
using NotificationService.Insfrastructure.Utilities.Security.Jwt;

namespace NotificationService.Insfrastructure.Utilities.Identity
{
